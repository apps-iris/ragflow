...
def _get_or_create_secret_key():
    ...
    # Fall back to Redis-persisted auto-generated key
    generated_key = secrets.token_hex(32)
    secret_key = REDIS_CONN.get_or_create_secret_key("ragflow:system:secret_key", generated_key)
    logging.warning("SECURITY WARNING: Using auto-generated SECRET_KEY. Set RAGFLOW_SECRET_KEY env var to fix this.")
    return secret_key
